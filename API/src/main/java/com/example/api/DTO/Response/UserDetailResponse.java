...
public class UserDetailResponse {
    ...
    private List<ExpoOverviewResponse> historyExpoOverview;
    private List<ExpoOverviewResponse> currentExpoOverview;
    private List<BoothOverviewResponse> currentBoothOverview;
    ...
    public static UserDetailResponse fromUser(User user) {
        ...
        response.historyExpoOverview = new ArrayList<>();
        response.currentExpoOverview = new ArrayList<>();
        response.currentBoothOverview = new ArrayList<>();
